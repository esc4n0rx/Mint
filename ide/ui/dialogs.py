...
class SettingsDialog(QDialog):
    def __init__(self, settings: dict, parent=None):
        ...
        self.setWindowTitle('Configurações do ERP Studio')
        ...
        self.use_spaces = QCheckBox('Usar espaços no editor')
        self.use_spaces.setChecked(settings.get('use_spaces', True))
        self.auto_lint = QCheckBox('Validar automaticamente ao salvar')
        ...
        form.addRow('Tema visual', self.theme)
        form.addRow('Fonte do editor', self.font_size)
